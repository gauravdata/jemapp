...
/**
 * Payment method class for AcceptGiro
 */
class Comaxx_Docdata_Model_Method_Acceptgiro extends Comaxx_Docdata_Model_Method_Abstract
{
	protected $_code = 'docdata_ag';
