...
/**
 * Payment method class for ING Home Pay
 */
class Comaxx_Docdata_Model_Method_Inghomepay extends Comaxx_Docdata_Model_Method_Abstract {
	protected $_code = 'docdata_inghp';
