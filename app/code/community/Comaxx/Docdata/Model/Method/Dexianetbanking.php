...
/**
 * Payment method class for Dexia Netbanking
 */
class Comaxx_Docdata_Model_Method_Dexianetbanking extends Comaxx_Docdata_Model_Method_Abstract {
	protected $_code = 'docdata_dnb';
