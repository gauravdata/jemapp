 ...
 */
class MageWorx_CustomerCredit_Adminhtml_RulesController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction() {        
        ...
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('customercredit/adminhtml_rules'))
            ->renderLayout();
    }
    ...
    public function editAction() {
        ...
        $block = $this->getLayout()->createBlock('customercredit/adminhtml_rules_edit')
