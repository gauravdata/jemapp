...
/**
 * Nscexport nejlepsiceny model 
 *
 * @category   Nostress
 * @package    Nostress_NscexportNejlepsiceny 
 */

class Nostress_Nscexport_Model_Nscexportnejlepsiceny extends Mage_Core_Model_Abstract
{	
    ...
    {
        parent::_construct();
        $this->_init('nscexport/nscexportnejlepsiceny');
    }	 
