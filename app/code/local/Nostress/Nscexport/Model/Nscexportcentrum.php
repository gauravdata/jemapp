...
/**
 * Nscexport centrum model 
 *
 * @category   Nostress
 * @package    Nostress_NscexportCentrum 
 */

class Nostress_Nscexport_Model_Nscexportcentrum extends Mage_Core_Model_Abstract
{	
    ...
    {
        parent::_construct();
        $this->_init('nscexport/nscexportcentrum');
    }	 
    ...
    {    
        ...
        $result .= Nostress_Nscexport_Helper_Data::formatProductAttribute('CATEGORYTEXT',true,$this->model->getProductCategoryName());               
        $result .= Nostress_Nscexport_Helper_Data::formatProductAttribute('CATEGORYCENTRUM',false,$this->model->getCentrumcategory());
