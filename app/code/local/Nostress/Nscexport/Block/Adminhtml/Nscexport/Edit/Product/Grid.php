...
class Nostress_Nscexport_Block_Adminhtml_Nscexport_Edit_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return Mage::app()->getStore(Mage::registry("nscexport_storeid"));
    }
    ...
    protected function _prepareCollection()
    {
        ...
        if(!isset($categoryId))
        	$categoryId = 0;
        $collection = Nostress_Nscexport_Helper_Data::prepareCategoryProductCollection($store,$this->getCategory());
		...
		//$s = $collection->getSelect()->_toString();
