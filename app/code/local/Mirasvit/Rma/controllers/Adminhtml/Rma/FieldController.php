...
class Mirasvit_Rma_Adminhtml_Rma_FieldController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return Mirasvit_Rma_Adminhtml_Rma_FieldController
     */
    ...
    public function editAction()
    {
        ...
        if ($field->getId()) {
            ...
            Mage::getSingleton('adminhtml/session')->addError(
                Mage::helper('adminhtml')->__('The Field does not exist.'));
            $this->_redirect('*/*/');
        }
    }
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('adminhtml')->__('Field was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(
            Mage::helper('adminhtml')->__('Unable to find Field to save'));
        $this->_redirect('*/*/');
    }
    ...
    public function massChangeAction()
    {
        ...
        if (!is_array($ids)) {
            Mage::getSingleton('adminhtml/session')->addError(
                Mage::helper('adminhtml')->__('Please select Field(s)'));
        } else {
            try {
                $isActive = $this->getRequest()->getParam('is_active');
                foreach ($ids as $id) {
                    /** @var Mirasvit_Rma_Model_Field $field */
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('rma/dictionary/field');
    }
