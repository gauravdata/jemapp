...
class Mirasvit_Rma_Adminhtml_Rma_RuleController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()
            ->createBlock('rma/adminhtml_rule'));
        $this->renderLayout();
    }
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('rma/adminhtml_rule_edit'))
                ->_addLeft($this->getLayout()->createBlock('rma/adminhtml_rule_edit_tabs'));
        ...
        if (!is_array($ids)) {
            ...
            try {
                ...
                foreach ($ids as $id) {
                    ...
                    $rule = Mage::getModel('rma/rule')->load($id);
    ...
    public function newConditionHtmlAction()
    {
        ...
        $model = Mage::getModel($type)
            ->setId($id)
            ->setType($type)
            ->setRule(Mage::getModel('rma/rule'))
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('rma/rule');
    }
