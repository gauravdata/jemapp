...
class Mirasvit_Rma_Adminhtml_Rma_TemplateController extends Mage_Adminhtml_Controller_Action
{
    /**
     * @return Mirasvit_Rma_Adminhtml_Rma_TemplateController
     */
    ...
    public function addAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('adminhtml')->__('Add Template '),
            Mage::helper('adminhtml')->__('Add Template'));
    ...
    public function editAction()
    {
        ...
        if ($template->getId()) {
            ...
            Mage::getSingleton('adminhtml/session')->addError(
                Mage::helper('adminhtml')->__('The Template does not exist.'));
            $this->_redirect('*/*/');
        }
    }
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('adminhtml')->__('Template was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(
            Mage::helper('adminhtml')->__('Unable to find Template to save'));
        $this->_redirect('*/*/');
    }
    ...
    public function massChangeAction()
    {
        ...
        if (!is_array($ids)) {
            ...
            try {
                ...
                foreach ($ids as $id) {
                    /** @var Mirasvit_Rma_Model_Template $template */
    ...
    /**
     * @return Mirasvit_Rma_Model_Template
     */
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('rma/dictionary/template');
    }
