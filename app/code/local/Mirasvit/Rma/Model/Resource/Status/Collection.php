...
/**
 * @method Mirasvit_Rma_Model_Status getFirstItem()
 * @method Mirasvit_Rma_Model_Status getLastItem()
 * @method Mirasvit_Rma_Model_Resource_Status_Collection|Mirasvit_Rma_Model_Status[] addFieldToFilter
 * @method Mirasvit_Rma_Model_Resource_Status_Collection|Mirasvit_Rma_Model_Status[] setOrder
 */
class Mirasvit_Rma_Model_Resource_Status_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function toOptionArray($emptyOption = false)
    {
        ...
        /** @var Mirasvit_Rma_Model_Status $item */
