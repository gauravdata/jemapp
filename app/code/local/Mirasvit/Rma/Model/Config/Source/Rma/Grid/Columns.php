...
class Mirasvit_Rma_Model_Config_Source_Rma_Grid_Columns
{
    public function toArray()
    {
        $options = array(
            ...
            Mirasvit_Rma_Model_Config::RMA_GRID_COLUMNS_CUSTOMER_EMAIL => Mage::helper('rma')->__('Customer Email'),
            ...
            Mirasvit_Rma_Model_Config::RMA_GRID_COLUMNS_ITEMS => Mage::helper('rma')->__('Items'),
        );
