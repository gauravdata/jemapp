...
class Mirasvit_Rma_Block_Adminhtml_Template_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm() {
        ...
        $fieldset->addField('template', 'textarea', array(
            ...
            'note'      => Mage::helper('rma')->__('You can use variables: [rma_increment_id], [rma_firstname], [rma_lastname], [store_name], [store_phone], [store_address], [user_firstname], [user_lastname], [user_email]'),
        ));
