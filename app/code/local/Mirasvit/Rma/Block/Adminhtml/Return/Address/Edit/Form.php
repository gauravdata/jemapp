...
class Mirasvit_Rma_Block_Adminhtml_Return_Address_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $address = Mage::registry('current_return_address');
        ...
        $fieldset->addField('address', 'textarea', array(
            'label' => Mage::helper('rma')->__('Address'),
            'name' => 'address',
