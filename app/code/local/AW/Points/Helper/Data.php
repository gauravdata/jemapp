...
class AW_Points_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getBaseSubtotalWithDiscountApplied($quote)
    {
        $baseSubtotalWithDiscountApplied = 0;
        if (is_object($quote)) {
            ...
            $baseSubtotalWithDiscountApplied = $baseSubtotal - $baseDiscountAmount;
        }

        return $baseSubtotalWithDiscountApplied;
    }
