...
class AW_Points_Model_Transaction extends Mage_Core_Model_Abstract
{
    ...
    public function changePoints($amount, $action, $summary, $additionalData = array())
    {
        ...
        $amount = $this->getAdjustedPointsAmount($amount, $summary);
    ...
    private function getAdjustedPointsAmount($amount, $summary)
    {
        $adjustedAmount = $amount;
        if (($summary->getPoints() + $amount) < 0) {
            $adjustedAmount = - $summary->getPoints();
        }
