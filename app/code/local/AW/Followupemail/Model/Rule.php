    ...
    protected function _getTemplate($templateId, $storeId = null)
    {
        ...
        if (!$pos) {
            ...
            switch ($src = substr($templateId, 0, $pos)) {
                ...
                case AW_Followupemail_Model_Source_Rule_Template::TEMPLATE_SOURCE_AW_ADVANCED_NEWSLETTER :
                    $template = $this->getResource()->getTemplateContent('advancednewsletter/template', $templateName);
                    break;
            ...
            foreach ($chain as $chainItem) {
                ...
                if ($this->getCouponEnabled()) {
                    ...
                    if (preg_match_all($pattern2, $emailTemplateContent, $matches) > 0) {
                        ...
                        Mage::getSingleton('followupemail/log')->logSuccess($message, $this, $subject);
                        $_dateStr = Mage::app()->getLocale()->date($coupon->getExpirationDate(), null, null, false)->toString($formatDate);
