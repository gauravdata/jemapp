 ...
 * Last Modified: 2013-05-31T15:54:05+02:00
...
class Xtento_GridActions_Model_Observer
{
    ...
    {
        if (stristr($actionCode, 'invoice') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/invoice')) {
            return false;
        }
        if (stristr($actionCode, 'ship') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/ship')) {
            return false;
        }
        if (stristr($actionCode, 'print') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/print')) {
            return false;
        }
        if (stristr($actionCode, 'complete') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/complete')) {
            return false;
        }
        if (stristr($actionCode, 'notify') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/email')) {
            return false;
        }
        if (stristr($actionCode, 'setstatus') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/change_status')) {
            return false;
        }
        if (stristr($actionCode, 'delete') && !Mage::getSingleton('admin/session')->isAllowed('system/config/gridactions/actions/delete')) {
            return false;
        }
        return true;
    }
