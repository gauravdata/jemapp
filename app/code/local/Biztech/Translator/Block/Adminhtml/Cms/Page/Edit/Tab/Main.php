...
class Biztech_Translator_Block_Adminhtml_Cms_Page_Edit_Tab_Main
    extends Mage_Adminhtml_Block_Cms_Page_Edit_Tab_Main    
{
    protected function _prepareForm()
    {
        ...
        /*$renderer = $this->getLayout()->createBlock('adminhtml/widget_form_renderer_fieldset_element')
            ->setTemplate('translator/cms/page/edit/form/renderer/main.phtml');
            $pageTitleField->setRenderer($renderer);*/
