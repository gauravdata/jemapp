<?php
    ...
    */
    class Biztech_Translator_Block_Adminhtml_Cms_Page_Edit extends Mage_Adminhtml_Block_Cms_Page_Edit
    {
        /**
        ...
        */
        protected function _prepareLayout()
        {
            ...
            $popup_data = '<div class="overlay_magento" id="admin-popup-overlay-meta" style="display: none; position: fixed; top: 0px; left: 0px; z-index: 1001; width: 100%; height: 100%;"></div>';
            $popup_data.='<div class="overlay_magento" id="error-overlay-meta" style="display: none; position: absolute; top: 0px; left: 0px; z-index: 1001; width: 100%; height: 1099px;"></div>';
            ...
            $main_popup_data = '<div class="overlay_magento" id="admin-popup-overlay-main" style="display: none; position: fixed; top: 0px; left: 0px; z-index: 1001; width: 100%; height: 100%;"></div>';
            $main_popup_data.='<div class="overlay_magento" id="error-overlay-main" style="display: none; position: absolute; top: 0px; left: 0px; z-index: 1001; width: 100%; height: 1099px;"></div>';
            $main_popup_data.='<div id="popup-error" class="magento_content" style="position: absolute; display: none; width: 500px; z-index: 1011; top: 40%; left: 40%; height: 150px">';
            $main_popup_data.='<div class="magento_close" id="widget_window_close" onclick="closewindow()"></div>';
            $main_popup_data.='<div class="top table_window" style="height: 30px; padding-left: 10px;">';
            $main_popup_data.='<div class="magento_title">"'.$this->__('Error:').'"</div>';
            $main_popup_data.='</div>';
            $main_popup_data.='</div>';
            ...
            if(Mage::getStoreConfig('translator/translator_general/enabled')){
                ...
                $('page_meta_fieldset').insert({ after: '".$popup_data."'});
                $('page_base_fieldset').insert({ after: '".$main_popup_data."'});
                });
