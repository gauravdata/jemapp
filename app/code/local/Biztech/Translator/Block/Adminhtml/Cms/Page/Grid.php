 ...
 */
class Biztech_Translator_Block_Adminhtml_Cms_Page_Grid extends Mage_Adminhtml_Block_Cms_Page_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->setMassactionIdField('cms_page_id');
        ...
        if(Mage::helper('translator')->isEnable()){
           $this->getMassactionBlock()->addItem('translator', array(
                'label'    => Mage::helper('translator')->__('Translate Selected CMS Page'),
                'url'      => $this->getUrl('adminhtml/translator/masstranslatecmspage'),
                'additional' => array(
                    'store_id' => array(
                        'name' => 'store_id',
                        'type' => 'hidden',
