<?php
    class Biztech_Translator_Block_Adminhtml_Enabledisable extends Mage_Adminhtml_Block_System_Config_Form_Field {
        protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {            
            ...
            if (! empty($websites)) {
                ...
                $isenabled = Mage::app()->getWebsite($websiteId)->getConfig('translator/activation/key');
