...
/**
 * Nscexport tovar model 
 *
 * @category   Nostress
 * @package    Nostress_NscexportTovar 
 */

class Nostress_Nscexport_Model_Nscexporttovar extends Mage_Core_Model_Abstract
{	
    ...
    {
        parent::_construct();
        $this->_init('nscexport/nscexporttovar');
    }	 
    ...
    {    
        ...
        if($this->model->getProductIsInStock())
        	$result .= Nostress_Nscexport_Helper_Data::formatProductAttribute('AVAILABILITY',false,0);                       
        $result .="</SHOPITEM>\n";
