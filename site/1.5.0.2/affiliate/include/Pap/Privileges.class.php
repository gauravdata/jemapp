...
abstract class Pap_Privileges extends Gpf_Privileges {
	...
	const MAIL_OUTBOX = "mail_outbox"; // P_READ
	...
	const TRANSACTION = "transaction"; // P_ADD, P_DELETE, P_EXPORT, P_EXPORT_OWN, P_READ, P_READ_OWN, P_WRITE
	...
	protected function initObjectRelation() {
		...
		self::MAIL_OUTBOX=>array(self::P_READ),
		...
		self::TRANSACTION=>array(self::P_ADD, self::P_DELETE, self::P_EXPORT, self::P_EXPORT_OWN, self::P_READ, self::P_READ_OWN, self::P_WRITE),
