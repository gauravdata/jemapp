...
'Email was successfuly sent to merchant'=>'Email je uspešno poslat trgovcu',
...
'Commission successfuly computed'=>'Provizija je uspešno obračunata',
...
'Commissions saved successfuly'=>'Provizija uspešno sačuvana',
...
'File was succesfuly uploaded'=>'Fajl je uspešno podignut',
...
'Your campaign was succesfuly defined'=>'Vaša kampanja je uspešno definisana',
...
'Recognize  duplicate orders comming from same IP address within'=>'Prepoznajte duple narudžbine koje stižu sa iste IP adrese u roku od',
'What to do with these orders'=>'Šta da se uradi sa ovim porudžbinama',
'Recognize duplicate orders comming with the same order ID within'=>'Prepoznaje duple porudžbine koje imaju istu ID porudžbine u roku od',
...
'1. Check if you have your tracking codes on place'=>'1. Proverite da li je kod za praćenje na mestu',
...
'2. Turn on debugging'=>'2. Uključite debagovanje',
'3. Make test click or sale'=>'3. Učinite test klik ili prodaju',
'3. Check Event log for the logged actions'=>'3. Proverite log dešavanja za ubeležene akcije',
...
'Plugin was successfuly activated'=>'Plagin je uspešno aktiviran',
'Plugin was successfuly deactivated'=>'Plagin je uspešno isključen',
'General'=>'Generalno',
...
'The installation finished successfuly. Thank you for choosing our product.'=>'Instalacije je uspešno završena. Hvala što ste izabrali naš proizvod.',
...
'%s saved'=>'%s sačuvano',
'%s was successfuly added'=>'%s je uspešno dodat',
'Row'=>'Red',
...
'Commissions added successfuly'=>'Provizija je uspešno dodata',
...
'You can set that the click from this URL will belong to a selected channel, 
  banner or campaign. If you don\'t select anything, the default campaign will be used.'=>'Možete da podesite da klik sa ovog url-a pripada jednom kanalu, baneru ili kampanji. Ako ništa ne izaberete, biće korišćena osnovna kampanja.',
...
'Key %s does not exist in dictionary'=>'Ključ %s ne postoji u rečniku',
