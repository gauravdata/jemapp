...
'Email was successfuly sent to merchant'=>'Электрондық пошта сәтті жіберілді',
...
'Commission successfuly computed'=>'Науқан сәтті есептелді',
...
'Commissions saved successfuly'=>'Комиссия сәтті сақталды',
...
'File was succesfuly uploaded'=>'Файл сәтті кері қотарылды',
...
'Your campaign was succesfuly defined'=>'Сіздің науқаныңыз сәтті айқындалды.',
...
'Recognize  duplicate orders comming from same IP address within'=>'IP мекенжайынан келген бірдей ретті  тану ',
'What to do with these orders'=>'Мына реттерді не істейсіз',
'Recognize duplicate orders comming with the same order ID within'=>'IP мекенжайынан келген бірдей ретті тану',
...
'1. Check if you have your tracking codes on place'=>'1. Егер бақылау кодыңыз болса, тексеріңіз',
...
'2. Turn on debugging'=>'2. Қосуды жөндеу',
'3. Make test click or sale'=>'3. Сынақтан өткізу нұқуын немесе сатуды жасау',
'3. Check Event log for the logged actions'=>'3. Тіркелген әрекет үшін оқиға жұрналын тексеру',
...
'Plugin was successfuly activated'=>'Plugin сәтті белсендендірілді',
'Plugin was successfuly deactivated'=>'Plugin сәтті дезактивацияланды',
'General'=>'Жалпы',
...
'The installation finished successfuly. Thank you for choosing our product.'=>'Орнату сәтті аяқталды. Біздің өнімді таңдағаныңыз үшін алғыс айтамыз. ',
...
'%s saved'=>'%s сақталды',
'%s was successfuly added'=>'%s сәтті қосылды',
'Row'=>'өңделмеген',
...
'Commissions added successfuly'=>'Комиссиялар сәтті қосылды',
...
'Key %s does not exist in dictionary'=>'%s пернесі сөздікте жоқ',
' does not exist'=>' жоқ',
' saved'=>' сақталған',
' added'=>' Қосылды',
...
'Index %s does not exist in array'=>'Жиымда реттеуіш %s жоқ',
...
'WARNING: VAT constants will be empty if you show preview for the affiliate that has VAT invoicing disabled.'=>'ЕСЕРТУ: ҚҚС тұрақты мәндері бос болуы керек.',
...
'Key %s does not contain %s it contains %s'=>'Кілт %s қамтымайды %s ол %s қамтиды',
'Credits'=>'Несиелер',
...
'Error during '=>'Қате ',
'Coupons are successfuly '=>'купондар сәтті ',
