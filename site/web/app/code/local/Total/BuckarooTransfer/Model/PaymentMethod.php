<?php
class Total_BuckarooTransfer_Model_PaymentMethod extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    * @var string [a-z0-9_]
    */
    protected $_code = 'buckarootransfer';

    protected $_formBlockType = 'buckarootransfer/checkout_form';
    /**
    ...
    public function getOrderPlaceRedirectUrl()
    {
    	...
    	return Mage::getUrl('buckarootransfer/checkout/redirect', array('_secure' => true));
    }
