...
class MageWorx_CustomerCredit_Adminhtml_Import_CodeController extends MageWorx_CustomerCredit_Controller_Adminhtml_Import
{
    ...
    public function runGenerateAction() {
        $import = Mage::getModel('customercredit/import_code')->run();
