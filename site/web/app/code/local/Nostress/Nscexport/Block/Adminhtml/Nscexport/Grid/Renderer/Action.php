...
class Nostress_Nscexport_Block_Adminhtml_Nscexport_Grid_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
    public function render(Varien_Object $row)
    {
        $this->getColumn()->setActions(array(array(
            'url'     => $this->getUrl('*/adminhtml_nscexport/generate', array('export_id' => $row->getId(), 'searchengine' => strtolower($row->getSearchengine()))),
            'caption' => Mage::helper('nscexport')->__('Generate NOW'),
        )));
