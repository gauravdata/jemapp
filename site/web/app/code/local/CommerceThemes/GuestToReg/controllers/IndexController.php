	...
	public function postAction() {
		if($this->getRequest()->getPost()) {
			...
			*/
			...
			//1.4.x+
			$write_qry = $write->query("UPDATE ".Mage::getSingleton('core/resource')->getTableName('sales_flat_order')." SET customer_id = '". $customerId ."', customer_is_guest = '0', customer_group_id = '1' WHERE entity_id = '". $existingorder_entity_id ."'");
