...
/**
 * Payment method class for Carte Bleue
 */
class Comaxx_Docdata_Model_Method_Cartebleue extends Comaxx_Docdata_Model_Method_Abstract {
	protected $_code = 'docdata_cb';
