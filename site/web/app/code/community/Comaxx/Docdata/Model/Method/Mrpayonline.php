...
/**
 * Payment method class for Mr Pay Online
 */
class Comaxx_Docdata_Model_Method_Mrpayonline extends Comaxx_Docdata_Model_Method_Abstract {
	protected $_code = 'docdata_mpo';
