var mtEditor = (function($) {
    ...
    var initNewTemplate = function() {
        ...
        $('#esns_box_layer button[data-action="1"]').click(function(){
            if (validate()) {
                ...
                var locale = $('#esns_box_layer select[name="email_locale"]').val();
    ...
    var initBlockEvent = function() {
        ...
        $('a[data-selector="edit-plain-text"]').unbind('click').click(function(){
            popup.content({
                contentSelector: '#edit_plain_text',
                disableClose: false
            }, function(){
            }, function() {
                var newValue = $('#esns_box_layer textarea[name="plain_text"]').val();
                $('#edit_plain_text textarea').text(newValue);
                console.log(config.action.savePlainAjaxUrl);
                sendRequest(config.action.savePlainAjaxUrl, {
                    content: newValue,
    ...
    var updateSelectedImageSize = function() {
        $('.'+textEditHelper.config.classes.helperImg).css({
            ...
            'max-width': $('#image-width').val()
        }).attr('alt', $('#image-alt').val());
    };
    ...
    var initDragAndDrop = function() {
        ...
        $( "#email" ).sortable({
            ...
            update: function(event, ui) {
                ...
                var newBlockId = new Date().getTime();
