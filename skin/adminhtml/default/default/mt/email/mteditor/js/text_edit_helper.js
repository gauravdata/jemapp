var textEditHelper = (function($){
    ...
    var initEvent  = function() {
        ...
        $('#email').unbind('click').click(function(e) {
            ...
            if (!elm.is('img') && (elm.is('a') || elm.parents('a[contenteditable="false"]').length > 0)) {
                ...
                console.log('#email parent contenteditable click');
    ...
    var addImgHelper = function(elm) { console.log('added img helper');
    ...
    var doBoldText = function () {
        ...
        if (!selectedContent) {
            ...
            console.log(selectedContent.split('<b>'));
